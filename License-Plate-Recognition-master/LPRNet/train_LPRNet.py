...
def get_parser():
    ...
    parser.add_argument('--train_img_dirs', default="~/datasets/rec_images/train", help='the train images path')
    parser.add_argument('--test_img_dirs', default="~/datasets/rec_images/val", help='the test images path')
